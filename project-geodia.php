...
<body id="Top" class="Wrapper fadeIn animated ProjectBody">
	...
	<section class="ProjectHeader">
		<div class="ProjectHeaderWrapper">
			...
			<p class="ProjectDescriptionTemplate">The land surveyor is a person exercising a profession which basically consists in establishing various measures affecting land properties.</p>
	...
	<section class="ProjectContent">
		<div class="ProjectContentWrapper">
			...
			<div class="ProjectContentTxtWrapper">
				...
				<p data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-out" data-aos-delay="70"class="ProjectContentTxtP"><span class="StrongProjectTxt"> Creation of a multi-page template</span> intended for Surveyors. Homepage, article page, activity page and offices page with also a route to request a quote.</p>
			</div>
	...
	<section class="NextProject">
		<div data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-out" data-aos-delay="70">
			<a class="CTA CTANextProject" href="project-iswt.php">Next Project
