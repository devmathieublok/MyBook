...
<body id="Top" class="Wrapper fadeIn animated ProjectBody">
	...
	<section class="ProjectHeader">
		<div class="ProjectHeaderWrapper">
			<h1 class="ProjectNameTemplate BlackColor">InSunWeTrust</h1>
			<p class="ProjectDescriptionTemplate">In Sun We Trust compares quotes and finds the best solar panels<br class="BrIswtProject"> installer for your home.</p>
			<div class="ProjectTemplateTagsWrapper">
				<p class="ProjectTemplateTag">Front Development</p>
				<p class="ProjectTemplateTag">Mar 2019</p>
			</div>
		</div>
	</section>
	<section class="ProjectContent">
		<div class="ProjectContentWrapper">
			<img class="ProjectContentImg" src="assets/img/projects/iswt/home.png" alt="Image Projet">
	...
	<section class="NextProject">
		<div data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-out" data-aos-delay="70">
			<a class="CTA CTANextProject" href="project-sodexo.php">Next Project
